...
namespace DevStudio.Controllers
{
    public class CommunityGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,GroupName,Url,Description")] CommunityGroup communityGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,GroupName,Url,Description")] CommunityGroup communityGroup)
        {
            if (ModelState.IsValid)
            {
